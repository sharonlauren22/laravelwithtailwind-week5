    ...
    <nav class="fixed w-full bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-9" alt="Sarong Logo" />
            </a>
                ...
                <ul
                    ...
                    <li>
                        <a href="<?php echo e(url('articles')); ?>"
                            class="block py-2 px-3 md:p-0 <?php echo e(request()->is('articles*') ? 'text-white bg-blue-700 md:text-blue-700 md:dark:text-blue-500 rounded md:bg-transparent' : 'text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700'); ?>"
...
<?php /**PATH /Applications/laragon/www/laravelwithtailwind-week5/resources/views/base/base.blade.php ENDPATH**/ ?>