<?php $__env->startSection('content'); ?>
    <div class="container mx-auto">
        ...
        <div class="max-w-xl mx-auto py-24">
            <?php if(Session::has('message') && Session::get('alert-class') == 'success'): ?>
                <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                    role="alert">
                    <?php echo e(Session::get('message')); ?>

                </div>
            <?php elseif(Session::has('message') && Session::get('alert-class') == 'failed'): ?>
...
<?php $component = App\View\Components\Button::resolve(['color' => 'cyan'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-3 inline-flex text-sm']); ?>
...
<?php endif; ?>
            ...
            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="prose lg:prose-xl py-3">
                    <div class="">
                        <form action="<?php echo e(route('articles.destroy', ['article' => $item->id])); ?>" method="POST"
                        ...
                        <a href="<?php echo e(route('articles.edit', ['article' => $item->id])); ?>" class="no-underline">
                            <button type="button"
                        ...
                        <a href="<?php echo e(route('articles.show', ['article' => $item->id])); ?>" class="no-underline">
                    ...
                    <div class="">
                        <button class="comment-button" type="button" aria-haspopup="dialog" aria-expanded="false"
                            ...
                            <?php echo e($item->number_of_comments()); ?>
...
<?php echo $__env->make('base.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/laragon/www/laravelwithtailwind-week5/resources/views/article/index.blade.php ENDPATH**/ ?>